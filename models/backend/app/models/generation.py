...
class Generation(Base):
    ...
    # One-to-one geometry row (created deterministically by geometry.service.ensure_geometry_assets).
    # viewonly: geometry is written via geometry.service.
    geometry: Mapped["GeometryAsset" | None] = relationship(
        "GeometryAsset",
        uselist=False,
        primaryjoin="Generation.id==GeometryAsset.generation_id",
        viewonly=True,
        lazy="selectin",
    )
